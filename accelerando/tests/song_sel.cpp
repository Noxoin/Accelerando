...
void Dot::move()
{
    ...
    //The dot can only move by 100 each time
    if (abs(mPosY - mOldPosY) > 100){
        mPosY -= mVelY;
    }
}
...
/*
	//Load up surface
	gKeyPressSurfaces[ KEY_PRESS_SURFACE_UP ] = loadTexture( "up.png" );
	...
	//Load down surface
	gKeyPressSurfaces[ KEY_PRESS_SURFACE_DOWN ] = loadTexture( "down.png" );
	...
	//Load left surface
	gKeyPressSurfaces[ KEY_PRESS_SURFACE_LEFT ] = loadTexture( "left.png" );
	...
	//Load right surface
	gKeyPressSurfaces[ KEY_PRESS_SURFACE_RIGHT ] = loadTexture( "right.png" );
